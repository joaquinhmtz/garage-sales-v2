    ...
    return (
        <>
            ...
            <div className="md:pt-6 md:pb-4 w-full">
                <p tabIndex={0} className="focus:outline-none text-base sm:text-lg md:text-xl lg:text-sm leading-normal text-gray-600">
                    Productos: [<span className="font-semibold">10</span>]
                </p>
            </div>

            <div className="w-full bg-white rounded-md p-6 ring-1 ring-gray-200">
                <div className="flex items-center justify-end">
                    <div className="py-1 pl-3 flex items-center text-sm font-medium leading-none text-gray-600 bg-gray-200 hover:bg-gray-300 cursor-pointer rounded">
                        <p>Ordenar por:</p>
                        <select aria-label="select" className="focus:text-indigo-600 focus:outline-none bg-transparent ml-1 border-none">
                ...
                <div className="mt-3 overflow-x-auto">
                    <table className="w-full mt-3 whitespace-nowrap">
                        <thead>
                            <tr tabIndex={0} className="focus:outline-none h-16 border border-gray-100 rounded text-base font-medium text-gray-700">
                                <th>Producto</th>
                                <th>Marca</th>
                                <th>Talla</th>
                                <th>Precio</th>
                        ...
                        <tbody>
                            ...
                            <tr tabIndex={0} className="focus:outline-none h-16 border border-gray-100 rounded">
                                <td className="text-sm leading-none text-gray-600">
            ...
            <div class="bg-white py-4 md:py-7 md:px-8 xl:px-8">
