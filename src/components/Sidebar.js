import { Bars3Icon, UserIcon, BellIcon } from '@heroicons/react/20/solid'
        ...
        <>
            <nav className="bg-white border-b border-gray-300">
                <div className="flex justify-between items-center px-9">
                    ...
                    <!-- Ícono de Menú --> */}
                    <button id="menuBtn">
                        <Bars3Icon className="h-5 w-5 text-cyan-500" aria-hidden="true"/>
                    </button>
                    ...
                    <div className="space-x-4">
                        <button>
                            <BellIcon className="h-5 w-5 text-cyan-500" aria-hidden="true"/>
                        </button>

                        {/* <!-- Botón de Perfil --> */}
                        <button>
                            <UserIcon className="h-5 w-5 text-cyan-500" aria-hidden="true"/>
                        </button>
                    </div>
                </div>
            </nav>
